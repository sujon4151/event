        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                ...
                <div class="card mb-4">
                    ...
                    <form class="card-body" method="POST" action="{{ route('athlete.update', $user->id) }}"
                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="top_pitch_velocity"
                                                                ...
                                                                value="{{ old('top_pitch_velocity', $user->statics->top_pitch_velocity) }}" />
                                                        </div>
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="top_spin" id="top_spin"
                                                                ...
                                                                value="{{ old('top_spin', $user->statics->top_spin) }}" />
                                                        </div>
                                                        <div class="col-md-3">
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_ch_spin"
                                                                value="{{ old('top_ch_spin', $user->statics->top_ch_spin) }}"
                                                                id="top_ch_spin" class="form-control"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_cb_spin" id="top_cb_spin"
                                                                class="form-control"
                                                                value="{{ old('top_cb_spin', $user->statics->top_cb_spin) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_sl_velocity"
                                                                value="{{ old('top_sl_velocity', $user->statics->top_sl_velocity) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_sl_spin" id="top_sl_spin"
                                                                class="form-control"
                                                                value="{{ old('top_sl_spin', $user->statics->top_sl_spin) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_ct_velocity"
                                                                value="{{ old('top_ct_velocity', $user->statics->top_ct_velocity) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_ct_spin" id="top_ct_spin"
                                                                value="{{ old('top_ct_spin', $user->statics->top_ct_spin) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_kn_velocity"
                                                                value="{{ old('top_kn_velocity', $user->statics->top_kn_velocity) }}"
                                                        ...
                                                        <div class="col-md-3">
                                                            ...
                                                            <input type="text" name="top_kn_spin"
                                                                value="{{ old('top_kn_spin', $user->statics->top_kn_spin) }}"
                                                                id="top_kn_spin" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="top_exit_velocity"
                                                                ...
                                                                value="{{ old('top_exit_velocity', $user->statics->top_exit_velocity) }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="max_distance"
                                                                value="{{ old('max_distance', $user->statics->max_distance) }}"
                                                                id="max_distance" class="form-control"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="inf_velocity"
                                                                value="{{ old('inf_velocity', $user->statics->inf_velocity) }}"
                                                                id="inf_velocity" class="form-control"
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="of_velocity"
                                                                value="{{ old('of_velocity', $user->statics->of_velocity) }}"
                                                                id="of_velocity" class="form-control"
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="c_pop" id="c_pop"
                                                                value="{{ old('c_pop', $user->statics->c_pop) }}"
                                                                class="form-control" placeholder="C-pop" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="vertical_jump" id="vertical_jump"
                                                                value="{{ old('vertical_jump', $user->statics->vertical_jump) }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="3d_resistance_score"
                                                                value="{{ old('3d_resistance_score', $user->statics['3d_resistance_score']) }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <input type="text" name="sprint_video" id="sprint_video"
                                                                value="{{ old('sprint_video', $user->statics->sprint_video) }}"
                                                                class="form-control" placeholder="Spint video link:" />
                                                        </div>
                                                        <div class="col-md-5">
                                                            ...
                                                            <input type="text" name="sprint_video_date"
                                                                ...
                                                                value="{{ old('sprint_video_date', $user->statics->sprint_video_date) }}"
                                                        ...
                                                        <div class="col-md-5">
                                                            ...
                                                            <input type="text" name="jump_video_link_date"
                                                                ...
                                                                value="{{ old('jump_video_link_date', $user->statics->jump_video_link_date) }}"
                                                                class=" form-control dob-picker"
                                                                placeholder="YYYY-MM-DD" />
                                                        </div>
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <input type="text" id="hitting_video" name="hitting_video"
                                                                value="{{ old('hitting_video', $user->statics->hitting_video) }}"
